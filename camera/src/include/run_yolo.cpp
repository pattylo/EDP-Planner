...
void run_yolo::findwhichboundingboxrocks(vector<cv::Mat> &netOutput, cv::Mat &frame)
{
    ...
    {
<<<<<<< HEAD:camera/src/include/run_yolo.cpp
...
>>>>>>> 7a3c5fe2576cf6da9cd063c06cf809b066234c58:camera_node/camera/src/include/run_yolo.cpp
        {
...
//        cout<<textoutputonframe<<endl;
        ...
        cv::putText(frame, textoutputonframe, cv::Point(final_x,final_y-10),cv::FONT_HERSHEY_COMPLEX_SMALL,1,cv::Scalar(50,50,100));
